...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $resultCekPeminjaman = $koneksi->query("SELECT * FROM peminjaman_barang WHERE id_barang = $idBarang AND jumlah = $jumlahPengembalian");
...
// Ambil data barang dari controller

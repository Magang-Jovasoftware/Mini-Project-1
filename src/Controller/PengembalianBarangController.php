...
class PengembalianBarangController {
    ...
    public function prosesPengembalian($idBarang, $jumlahPengembalian) {
        ...
        // Hapus data peminjaman jika stok barang mencukupi
        $resultHapusPeminjaman = $koneksi->query("DELETE FROM peminjaman_barang WHERE id_barang = $idBarang AND jumlah = $jumlahPengembalian");
